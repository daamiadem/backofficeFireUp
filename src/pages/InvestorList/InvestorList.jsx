...
export default class InvestorsList extends Component {
  ...
  componentDidMount() {
    axios.get('https://spacedevfireupbackend.herokuapp.com/api/investors')
      .then(response => {
  ...
  deleteInvestor(id) {
    axios.delete('https://spacedevfireupbackend.herokuapp.com/api/investors/deleteInvestor/'+id)
