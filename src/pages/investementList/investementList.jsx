...
export default class InvestementList extends Component {
  ...
  componentDidMount() {
    axios.get('https://spacedevfireupbackend.herokuapp.com/api/investement')
      .then(response => {
  ...
  deleteInvestement(id) {
    axios.delete('https://spacedevfireupbackend.herokuapp.com/api/investement/deleteInvestment/'+id)
