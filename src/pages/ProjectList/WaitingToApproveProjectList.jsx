...
export default function NotApprovedProjectList() {


    const navigate = useHistory();

    const [projects,err,reload] = useApi('project/getProjectsToApprove');
  ...
  return (   <>
       ...
       <div>
        ...
        <h1 style={{display: 'flex',  justifyContent:'center', alignItems:'center',color:'darkblue'}}>New Projects To Approve</h1>
